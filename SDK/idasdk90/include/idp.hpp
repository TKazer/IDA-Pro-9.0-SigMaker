...
struct processor_t
{
  ...
  enum event_t
  {
    ...
    ev_obsolete3,               ///< ev_gen_stkvar_def is obsolete,
                                ///< check ev_gen_stkvar_def2 below
    ...
    ev_gen_stkvar_def2,          ///< Generate stack variable definition line
                                ///< Default line is
  ...
  inline static ssize_t gen_stkvar_def2(outctx_t &ctx, const struct udm_t *mptr, sval_t v, tid_t tid);
...
inline ssize_t processor_t::gen_stkvar_def2(outctx_t &ctx, const struct udm_t *stkvar, sval_t v, tid_t tid)
{
  return notify(ev_gen_stkvar_def2, &ctx, stkvar, v, tid);
}
