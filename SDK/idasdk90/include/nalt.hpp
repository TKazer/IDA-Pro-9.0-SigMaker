...
///@{
#define  NALT_ENUM      uval_t(-2) ///< reserved for enums
...
/// function frame type
/// values NSUP_FRAME..NSUP_FRAME+0x1000 are reserved
...
#define AFL_USERSP      0x00000002     ///< user-defined SP value
#define AFL_PUBNAM      0x00000004     ///< name is public (inter-file linkage)
#define AFL_WEAKNAM     0x00000008     ///< name is weak
...
#define AFL_ZSTROFF     0x00000080     ///< display struct field name at 0 offset when displaying an offset.
                                       ...
                                       ///<   \v{offset somestruct}
#define AFL_BNOT0       0x00000100     ///< the 1st operand is bitwise negated
#define AFL_BNOT1       0x00000200     ///< the 2nd operand is bitwise negated
#define AFL_LIB         0x00000400     ///< item from the standard library.
                                       ///< low level flag, is used to set
                                       ///< #FUNC_LIB of ::func_t
#define AFL_TI          0x00000800     ///< has typeinfo? (#NSUP_TYPEINFO); used only for addresses, not for member_t
#define AFL_TI0         0x00001000     ///< has typeinfo for operand 0? (#NSUP_OPTYPES)
...
#define AFL_NORET       0x00400000     ///< for imported function pointers: doesn't return.
                                       ///< this flag can also be used for any instruction
                                       ///< which halts or finishes the program execution
#define AFL_FIXEDSPD    0x00800000     ///< sp delta value is fixed by analysis.
                                       ///< should not be modified by modules
#define AFL_ALIGNFLOW   0x01000000     ///< the previous insn was created for alignment purposes only
#define AFL_USERTI      0x02000000     ///< the type information is definitive.
...
#define AFL_TYPE_GUESSED    0xC2000000 ///< who guessed the type information?
#define AFL_IDA_GUESSED     0x00000000 ///< the type is guessed by IDA
#define AFL_HR_GUESSED_FUNC 0x40000000 ///< the function type is guessed by the decompiler
#define AFL_HR_GUESSED_DATA 0x80000000 ///< the data type is guessed by the decompiler
#define AFL_HR_DETERMINED   0xC0000000 ///< the type is definitely guessed by the decompiler
///@}
...
#define   AP_IDXDEC     0x00000000      ///< display indexes in decimal
#define   AP_IDXHEX     0x00000010      ///< display indexes in hex
#define   AP_IDXOCT     0x00000020      ///< display indexes in octal
#define   AP_IDXBIN     0x00000030      ///< display indexes in binary
